...
The [API3 Market](https://market.api3.org/fraxtal) provides access to 200+ price feeds on [Fraxtal Mainnet](https://market.api3.org/fraxtal). The price feeds operate as a native push oracle and can be activated instantly via the Market UI.
